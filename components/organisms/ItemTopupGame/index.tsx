...
export default function ItemTopupGame(props: ItemTopupGameProps) {
    ...
    return (
      <div className="row align-items-center">
        <div className="col-md-12 col-4">
          <img src={`${API_UPLOADS}/${data.thumbnail}`} width="280" height="380" className="img-fluid" alt="" />
        </div>
