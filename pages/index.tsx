          ...
          <div className="row gap-lg-0 gap-5">
            <div className="col-lg-6 col-12 my-auto">
              ...
              <h1 className="header-title color-palette-1 fw-bold">
                ...
                <span className="underline-blue"> New</span> <br className="d-sm-block d-none" /> <span className="underline-blue">Experience</span>{' '}
                in Gaming
              </h1>
                  ...
                  <div className="card left-card position-absolute border-0">
                    <div className="d-flex align-items-center mb-16 gap-3">
                      <div style={{ position: 'relative' }}>
                        <img src="/img/Header-2.png" className="rounded-pill" width="40" height="40" alt="" />
                      </div>
                      <div>
