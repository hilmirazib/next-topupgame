...
import { setSignUp } from '../serviceAPI/auth';
import { CategoryTypes } from '../serviceAPI/data-type';
import { getGameCategory } from '../serviceAPI/player';
...
export default function signUpPhoto() {
  ...
  const onSubmit = async () => {
    ...
    data.append('phoneNumber', '08978663783');
                ...
                <div className="image-upload text-center">
                  ...
                  <input
                    ...
                    onChange={(event: { target: { files: any } }) => {
                      const imgUpload = event.target.files[0];
                      setImagePreview(URL.createObjectURL(imgUpload));
